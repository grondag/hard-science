...
import static grondag.hs.HardScienceConfig.DEFAULTS;
import static grondag.hs.HardScienceConfig.useVanillaFonts;
...
import grondag.hs.HardScienceConfig;
...
public class ConfigScreen {
	...
	public static Screen getScreen(Screen parent) {
		...
		// MISC
		final ConfigCategory misc = builder.getOrCreateCategory(new TranslatableText("config.hard-science.category.misc"));


		misc.addEntry(ENTRY_BUILDER
				.startBooleanToggle(new TranslatableText("config.hard-science.value.use_vanilla_fonts"), useVanillaFonts)
				.setDefaultValue(DEFAULTS.useVanillaFonts)
				.setTooltip(parse("config.hard-science.help.use_vanilla_fonts"))
