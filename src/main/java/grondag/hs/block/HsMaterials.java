...
public abstract class HsMaterials {
	...
	public static final Material DURAGLASS = new FabricMaterialBuilder(MaterialColor.AIR).build();
	...
	public static final Material HYPERGLASS = new FabricMaterialBuilder(MaterialColor.AIR).blocksPistons().build();
